...
class _MobileNumberInputState extends State<MobileNumberInput> {
  List<Map<String, String>> allCountryCodes = [
  ...
  void _showCountryDialog(BuildContext context) {
    showDialog(
      ...
      // Handle the value returned from the dialog (if needed)
      if (value != null) {
        setState(() {
...
class _CountryDialogState extends State<CountryDialog> {
  ...
  void initState() {
    super.initState();
    filteredCountryCodes = List.from(widget.allCountryCodes);
    widget.searchController.addListener(() {
      searchCode(widget.searchController.text);
    });
  }
  ...
  void searchCode(String query) {
    ...
    setState(() {
      filteredCountryCodes = widget.allCountryCodes
          .where((country) =>
